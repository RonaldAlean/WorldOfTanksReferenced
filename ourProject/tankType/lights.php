<html lang="en" dir="ltr">
  ...
  <body>
	...
	//put your query here
	$query = "SELECT Tankname, Country.CountryName, Tanktier FROM Tank_List INNER JOIN Country ON Tank_List.CountryId=Country.CountryId WHERE Tanktype = 'Light' ORDER BY Tanktier";
