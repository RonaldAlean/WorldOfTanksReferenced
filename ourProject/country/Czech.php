<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h2></h2>
    <div class="navbar">
    <a href="http://students.cs.ndsu.nodak.edu/~busacker/Final%20Data%20Base/home.php">Home</a>
    <br>
    </div>
	...
	//put your query here
	$query = "SELECT Tankname, Tanktype, Tanktier FROM Tank_List WHERE CountryId = 9 ORDER BY Tanktier";
